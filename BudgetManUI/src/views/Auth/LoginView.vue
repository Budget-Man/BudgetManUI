      ...
      <div class="grid-content ep-bg-purple">
        ...
        <el-form ref="ruleFormRef" :model="state" status-icon label-width="px" class="demo-ruleForm">
          ...
          <el-form-item>
              ...
              <template #icon>
                <el-icon>
                  <svg width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><rect width='24' height='24' stroke='none' fill='#000000' opacity='0'/>
                    ...
                    <path style="stroke: rgb(255, 255, 255); stroke-width: 2; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: round; stroke-miterlimit: 4; fill: none; fill-rule: nonzero; opacity: 1;" transform=" translate(-12, -12)" d="M 8.5 4.707 L 8.5 1 L 22.5 1 L 22.5 23 L 8.5 23 L 8.5 19.707 M 1.5 12 L 17.5 12" stroke-linecap="round" />
                    </g>
                    <g transform="matrix(1 0 0 1 2.5 0)" >
                    <path style="stroke: rgb(255, 255, 255); stroke-width: 2; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: round; stroke-miterlimit: 4; fill: none; fill-rule: nonzero; opacity: 1;" transform=" translate(-14.5, -12)" d="M 11.5 6 L 17.5 12 L 11.5 18" stroke-linecap="round" />
                    </g>
                    </g>
                    </g>
                    </svg>
            ...
            <el-button type="default" @click="googleLogin" v-loading.fullscreen.lock="fullscreenLoading">
              <el-icon>
